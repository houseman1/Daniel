            ...
            <form id="formContact" method="POST" action="../controller/contact_validation.php">
                <div class="align-items-center">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control valid" id="valueNom" name="nom" placeholder="Veuillez saisir votre nom">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="valuePrenom" name="prenom" placeholder="Veuillez saisir votre prénom">
                    ...
                    <div class="form row">         
                        <div class="form-group col-12">
                            ...
                            <input class="form-control" type="date" id="valueDdn" name="ddn">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="valueCode" name="codeP">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="valueEmail" name="email" placeholder="dave.loper@afpa.fr">
                    ...
                    <div>
                        ...
                        <div class="custom-control custom-checkbox my-1 mr-sm-2">
                            <input type="checkbox" class="custom-control-input" id="customControlInline" name="sujet">
                        </div>
                        <!-- question -->
                        <div class="form-group">
                            <label for="valueQuestion">Votre question<sup>&lowast;</sup></label>
                            <textarea class="form-control" id="valueQuestion" name="question" rows="3"></textarea>
